...
export async function GET(request: NextRequest) {
    ...
    targetUrl.searchParams.set('action', 'wrong_list');
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch wrong list' }, { status: 500 });
    }
}
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to save wrong data' }, { status: 500 });
    }
}
